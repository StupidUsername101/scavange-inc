...
#######################################################
# Four-limb facade around the shared PPO feature auditor. Body-specific wording stays here while
...
static func status_text(report: Dictionary) -> String:
	return PPOFeatureAudit.status_text(report, "Limb PPO", "movement data", "body inputs")
