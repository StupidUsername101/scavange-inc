...
- The creator-facing Utility Manipulator Arm is a normal two-segment `GenericLimbDefinition` mounted through
...
- A Quad Drone with that articulated arm therefore currently has eight controls: four propellers plus
