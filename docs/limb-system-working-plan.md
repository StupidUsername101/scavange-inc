...
- PPO may own one to four explicitly authored propeller controls plus generic attachment controls. Creator-authored rotor geometry is exposed to PPO feedback through real local rotor positions, lift axes, and spin directions. SAC/SAC-HER remain restricted to the canonical stock four-corner rotor geometry because their structured warm-up mixer assigns fixed physical meaning to the four action indices.
